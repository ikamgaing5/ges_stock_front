export const en = {
  ...
  auth: {
    ...
    connexionDesc: "Access your stock management workspace",
    ...
    deuxFacteursTitre: "Two-Factor Authentication",
    deuxFacteursDesc: "Enter the code generated by your authenticator app or a backup code.",
