export const en = {
  ...
  auth: {
    ...
    emailIndisponible: "Cannot use this email address",
    ...
    villeBoutique: "City",
    niuBoutique: "Unique Tax ID (NIU)",
    niuAide: "Your company's unique tax identification number",
    registreCommerce: "Trade Register (RCCM)",
    registreCommerceAide: "Company trade and credit register number",
    logoBoutique: "Store logo",
    logoBoutiqueAide: "Displayed on invoices provided to your customers",
    seConnecter: "Sign in",
    ...
    sessionExpireeInactivite:
      "Your session has expired after 60 minutes of inactivity. Please log in again.",
  ...
  telephones: {
    ...
    rechercherClientPlaceholder: "Search or enter customer name...",
    clientExistant: "Existing customer",
    clientSelectionne: "Customer selected",
  ...
  factures: {
    titre: "My Invoices",
    description: "Browse, filter, and reprint sales invoices for your store.",
    numero: "Invoice #",
    dateHeure: "Date & Time",
    dateAchat: "Purchase date & time",
    client: "Customer",
    telephoneClient: "Phone",
    modePaiement: "Payment",
    montant: "Amount",
    totalFactures: "{total} invoice(s) recorded",
    recherchePlaceholder: "Search by customer, phone, IMEI, invoice #...",
    tousPaiements: "All payment methods",
    aucuneFacture: "No invoices found",
    aucuneFactureDesc: "No sales match the selected criteria.",
    voirFacture: "View invoice",
    imprimer: "Print / PDF",
    fermer: "Close",
    factureTitre: "INVOICE",
    detailsFacture: "Invoice details",
    informationsCommande: "Order information",
    commandePasseLe: "Order placed on",
    moyenPaiement: "Payment method",
    datePaiement: "Payment date",
    venduPar: "Salesperson",
    emetteurBoutique: "Issued by Store",
    clientFacture: "Billed to",
    articlesAchetes: "Item(s) bought",
    designation: "Item name",
    imei: "IMEI",
    prixUnitaire: "Price",
    quantite: "Qty",
    prixTotal: "Item price",
    totalCommande: "Order total",
    sousTotal: "Subtotal",
    total: "Total",
    notesTitre: "Notes:",
    notesGarantie: "Warranty: 1 month (30 days) from purchase date.",
  ...
  equipe: {
    ...
    creerSansEmail: "Create invitation (no email)",
    envoyerEmailInvitation: "Send invitation email",
    invitationCreeeSucces: "Invitation created successfully.",
    emailNonEnvoye: "Email not sent",
    emailEnvoye: "Email sent",
    copierLien: "Copy link",
    lienCopie: "Invitation link copied to clipboard!",
    envoyerEmailMaintenant: "Send email",
    renvoyerEmail: "Resend email",
    invitationModalTitre: "Invitation created!",
    invitationModalSansEmailDesc:
      "The invitation was created without sending an email. You can copy the link below to share it yourself (via WhatsApp, SMS, etc.).",
    invitationModalAvecEmailDesc:
      "The invitation has been saved and an email was sent to the provided address.",
    ...
    tableauEnvoyeLe: "Created on",
    tableauStatutEmail: "Email status",
    expiree: "Expired",
    enAttente: "Pending",
    ...
    motDePassePlaceholder: "Enter your password",
    confirmerMotDePasse: "Confirm my identity",
  ...
  boutiques: {
    ...
    verificationRequiseTitre: "Identity confirmation required",
    verificationRequiseDesc:
      "To manage your retail stores (add, edit, or delete a store), please confirm your identity.",
    methodeMotDePasse: "Password",
    methodeCodeEmail: "Code received by email",
    motDePasseLabel: "Your login password",
    motDePassePlaceholder: "Enter your password",
    confirmerMotDePasse: "Confirm my identity",
    demanderCodeEmailBtn: "Send code",
    envoyerCodeBtn: "Send code",
    ...
    retourVueEnvoi: "Back",
    renvoyerCodeDans: "Resend code in {secondes}s",
    codeEnvoyeA: "An 8-digit code was sent to {email}.",
    entrezCode8Chiffres: "Enter the 8-digit code received by email:",
    validerCode: "Validate code",
    accesDeverrouille: "Store management unlocked",
    verrouillerAcces: "Relock",
    verrouilleSucces: "Store management access has been relocked.",
    sessionDeverrouilleeInfo: "Secure session active for 30 minutes.",
  },
  scanner: {
  ...
  clients: {
    ...
    aucunClientDesc: "No customers match the search criteria.",
    aucunAchat: "No sales recorded yet.",
    totalClients: "Unique Customers",
    chiffreAffaires: "Total Revenue",
    panierMoyen: "Average Basket",
    clientsFideles: "Loyal Customers",
    clientsSelectionnes: "{count} customer(s) selected",
    campagneWhatsapp: "WhatsApp Campaign",
    exporterVcard: "Export WhatsApp Contacts (.vcf)",
    exporterCsv: "Export CSV",
    client: "Customer",
    telephone: "Phone",
    achats: "Purchases",
    totalDepense: "Total Spent",
    dernierAchat: "Last Purchase",
    premierAchat: "First Purchase",
    boutiques: "Stores",
    actions: "Actions",
    voirFiche: "View customer profile",
    ecrireWhatsapp: "Chat on WhatsApp",
    appeler: "Call",
    ficheClient: "Customer Profile",
    historiqueAchats: "Purchase History",
    appareil: "Device",
    imei: "IMEI",
    prix: "Price Paid",
    dateVente: "Sale Date",
    vendeur: "Salesperson",
    voirFacture: "Invoice",
    triRecent: "Last purchase (recent)",
    triDepenses: "Highest spending",
    ...
    apercuWhatsapp: "WhatsApp preview",
  },
  monCompte: {
    titre: "My Account",
    description:
