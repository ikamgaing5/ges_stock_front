export const en = {
  ...
  scanner: {
    ...
    description: "Use your device's camera or a hardware scanner to instantly identify any device.",
    ...
    nonTrouve: "No device found with this IMEI in your stores.",
    ...
    appareilInconnu: "Unknown device",
