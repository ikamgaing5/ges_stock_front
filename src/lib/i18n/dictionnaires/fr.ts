export const fr = {
  ...
  auth: {
    ...
    emailIndisponible: "Impossible d’utiliser cette adresse e-mail",
    ...
    villeBoutique: "Ville",
    niuBoutique: "Numéro d'Identification Unique (NIU)",
    niuAide: "Identifiant fiscal unique de votre entreprise",
    registreCommerce: "Registre de commerce (RCCM)",
    registreCommerceAide: "Numéro d'immatriculation au registre du commerce",
    logoBoutique: "Logo de la boutique",
    logoBoutiqueAide: "Affiché sur les factures remises à vos clients",
    ...
    sessionExpireeInactivite:
      "Votre session a expiré après 60 minutes d'inactivité. Veuillez vous reconnecter.",
  ...
  telephones: {
    ...
    rechercherClientPlaceholder: "Rechercher ou saisir un nom de client...",
    clientExistant: "Ancien client",
    clientSelectionne: "Client sélectionné",
    nouveauClient: "Nouveau client",
    nbAchats: "{nb} achat(s)",
    aucunClientTrouve: "Aucun ancien client trouvé",
    creerNouveauClient: "Nouveau client : « {nom} »",
    changerClient: "Changer",
    modePaiement: "Mode de règlement",
    modePaiementCash: "Cash (Espèces)",
    ...
    imprimerFacture: "Imprimer la facture",
  ...
  factures: {
    ...
    voirFacture: "Voir facture",
    imprimer: "Imprimer / PDF",
    fermer: "Fermer",
    factureTitre: "FACTURE",
    detailsFacture: "Détails de la facture",
    informationsCommande: "Informations de la commande",
    commandePasseLe: "Achat effectué le",
    moyenPaiement: "Mode de règlement",
    datePaiement: "Date de règlement",
    venduPar: "Vendeur",
    emetteurBoutique: "Boutique émettrice",
    clientFacture: "Facturé à",
    articlesAchetes: "Article(s) acheté(s)",
    designation: "Désignation",
    imei: "IMEI",
    prixUnitaire: "Prix",
    quantite: "Qté",
    prixTotal: "Prix total",
    totalCommande: "Total de la facture",
  ...
  equipe: {
    ...
    creerSansEmail: "Créer l'invitation (sans e-mail)",
    envoyerEmailInvitation: "Envoyer un e-mail d'invitation",
    invitationCreeeSucces: "Invitation créée avec succès.",
    emailNonEnvoye: "E-mail non envoyé",
    emailEnvoye: "E-mail envoyé",
    copierLien: "Copier le lien",
    lienCopie: "Lien d'invitation copié dans le presse-papier !",
    envoyerEmailMaintenant: "Envoyer l'e-mail",
    renvoyerEmail: "Renvoyer l'e-mail",
    invitationModalTitre: "Invitation créée !",
    invitationModalSansEmailDesc:
      "L'invitation a été créée sans envoyer d'e-mail. Vous pouvez copier le lien ci-dessous pour le transmettre vous-même (par WhatsApp, SMS, etc.).",
    invitationModalAvecEmailDesc:
      "L'invitation a été enregistrée et un e-mail a été envoyé à l'adresse indiquée.",
    ...
    tableauEnvoyeLe: "Créée le",
    tableauStatutEmail: "Statut e-mail",
    expiree: "Expirée",
    ...
    motDePassePlaceholder: "Entrez votre mot de passe",
    confirmerMotDePasse: "Confirmer mon identité",
  ...
  boutiques: {
    ...
    verificationRequiseTitre: "Confirmation d'identité requise",
    verificationRequiseDesc:
      "Pour gérer vos points de vente (ajouter, modifier ou supprimer une boutique), veuillez confirmer votre identité.",
    methodeMotDePasse: "Mot de passe",
    methodeCodeEmail: "Code reçu par e-mail",
    motDePasseLabel: "Votre mot de passe de connexion",
    motDePassePlaceholder: "Entrez votre mot de passe",
    ...
    entrezCode8Chiffres: "Saisissez le code à 8 chiffres reçu par e-mail :",
    validerCode: "Valider le code",
    accesDeverrouille: "Gestion des boutiques déverrouillée",
    verrouillerAcces: "Reverrouiller",
    verrouilleSucces: "L'accès à la gestion des boutiques a été reverrouillé.",
    sessionDeverrouilleeInfo: "Session sécurisée active pour 30 minutes.",
  },
  scanner: {
  ...
  clients: {
    ...
    aucunClientDesc: "Aucun client ne correspond aux critères de recherche.",
    aucunAchat: "Aucune vente enregistrée pour le moment.",
    totalClients: "Clients uniques",
    chiffreAffaires: "Chiffre d'affaires",
    panierMoyen: "Panier moyen",
    clientsFideles: "Clients fidèles",
    clientsSelectionnes: "{count} client(s) sélectionné(s)",
    campagneWhatsapp: "Campagne WhatsApp",
    exporterVcard: "Exporter Contacts WhatsApp (.vcf)",
    exporterCsv: "Exporter CSV",
    client: "Client",
    telephone: "Téléphone",
    achats: "Achats",
    totalDepense: "Total dépensé",
    dernierAchat: "Dernier achat",
    premierAchat: "Premier achat",
    boutiques: "Boutiques",
    actions: "Actions",
    voirFiche: "Voir la fiche client",
    ecrireWhatsapp: "Discuter sur WhatsApp",
    appeler: "Appeler",
    ficheClient: "Fiche Client",
    historiqueAchats: "Historique des achats",
    appareil: "Appareil",
    imei: "IMEI",
    prix: "Prix payé",
    ...
    vendeur: "Vendeur",
    voirFacture: "Facture",
    triRecent: "Dernier achat (récent)",
    triDepenses: "Plus de dépenses",
    ...
    apercuWhatsapp: "Aperçu du message WhatsApp",
  },
  monCompte: {
    titre: "Mon compte",
    description:
